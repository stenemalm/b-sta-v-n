...
/** @type {import('react').Context<{items:any[],add:(p:any,q?:number)=>void,remove:(id:number)=>void,update:(id:number,q:number)=>void,clear:()=>void,count:number,total:number}|null>} */
